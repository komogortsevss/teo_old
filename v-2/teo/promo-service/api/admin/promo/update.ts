...
export const apiAdminPromoUpdateRoute = app.post("/", async (ctx, req) => {
  ...
  // Обновляем код (с проверкой уникальности)
  if (body.code !== undefined) {
    ...
    // Проверяем уникальность, если код изменился
  ...
  // Обновляем минимальную сумму заказа
